...
function startServer(handleClientEvent) {
  SocketIOInterop.startServer(/* array */[
        customEventName,
        disconnectEventName
      ], /* Unauthenticated */0, (function (clientAuthentication, eventName, data, rawBroadcaster, rawSender) {
          ...
          return Curry._4(handleClientEvent, clientAuthentication, match ? /* Logout */0 : decodeClientCommand(data), (function (x) {
                        return Curry._2(rawBroadcaster, encodeServerEvent(x), customEventName);
                      }), (function (x) {
                        return Curry._2(rawSender, encodeServerEvent(x), customEventName);
                      }));
        }));
  return /* () */0;
}
...
exports.customEventName = customEventName;
