  ...
  SocketIOInterop.startServer(/* array */[
        ...
        disconnectEventName
          ...
          return Curry._4(handleClientEvent, clientAuthentication, match ? /* Logout */0 : decodeClientCommand(data), (function (x) {
                        return Curry._2(rawBroadcaster, encodeServerEvent(x), customClientEventName);
                      }), (function (x) {
                        return Curry._2(rawSender, encodeServerEvent(x), customClientEventName);
                      }));
        }));
  return /* () */0;
}
...
exports.customClientEventName = customClientEventName;
exports.customServerEventName = customServerEventName;
