...
function mapClientCommand(auth, clientCommand) {
  if (auth) {
    var user = auth[0];
    ...
    return /* tuple */[
            ...
            /* LoginSuccessful */Block.__(0, [ChatRepository$ReasonableChatServer.getState(/* () */0)])
          ];
  }
}

exports.mapClientCommand = mapClientCommand;
/* No side effect */
